...
# ds_ch8_Introduction to Data Visualization with Matplotlib

#___________________________________________________________________________________
##  Part I Introduction to Matplotlib
#___________________________________________________________________________________

''' 
#1) #Using the matplotlib.pyplot interface
...
#2) Adding data to an Axes object
# Import the matplotlib.pyplot submodule and name it plt
import matplotlib.pyplot as plt
...
#4)Customizing axis labels and adding titles


#5)ax.plot(seattle_weather["MONTH"], seattle_weather["MLY-PRCP-NORMAL"])
ax.plot(austin_weather["MONTH"], austin_weather["MLY-PRCP-NORMAL"])
...
#  Part II Plotting time-series data
___________________________________________________________________________________
'''
# 
...
___________________________________________________________________________________
##  Part III Quantitative comparisons: bar-charts
#___________________________________________________________________________________
...
___________________________________________________________________________________
##  Part IV Sharing visualizations with others
#___________________________________________________________________________________
'''
# 
