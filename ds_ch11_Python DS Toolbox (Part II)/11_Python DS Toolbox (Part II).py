...
##  Part I Using iterators in PythonLand
___________________________________________________________________________________
'''
...
#4)Iterators as function arguments
...
#8)Processing large amounts of Twitter data
...
#9)Extracting information for large amounts of Twitter data
...
#5)Using conditionals in comprehensions (1)
...
#6)Using conditionals in comprehensions (2)
# Create a list of strings: fellowship
fellowship = ['frodo', 'samwise', 'merry', 'aragorn', 'legolas', 'boromir', 'gimli']
...
# dict comprehension use of curly braces {} instead of []
# Additionally members of dictionary are created using <key> : <value>.
...
#9)Write your own generator expressions
# Create generator object: result
result = (num for num in range(0,31))

# Print the first 5 values
#print('next01:', next(result))
#print('next02:', next(result))
print(next(result))
print(next(result))
print(next(result))
print(next(result))
...
# access the 12th to 19th characters in the string to extract the time.
...
#6)Writing a generator to load data in chunks (2)
...
#7)Writing a generator to load data in chunks (3)
# Initialize an empty dictionary: counts_dict
counts_dict = {}
...
with open('world_dev_ind.csv') as file:
    ...
    # the generator Input is the same as was declared in 
    # gen_file = read_large_file(file)
    # there, reads the line and apply for loop in it.
...
#8)Writing an iterator to load data in chunks (1)
# Import the pandas package
import pandas as pd
...
#9)Writing an iterator to load data in chunks (2)
...
#df_pop_ceb['Total Urban Population'] = [int(i,i*0.01) for i in pops_list]
